public class Gio3 : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("dota3", "dota3", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "arial  color=#000000", 80);
			
			mainscene = add_sprite_for_image(SEImage.for_resource("home"));
		    sprite = add_sprite_for_image(SEImage.for_resource("dota3"));
			text = add_sprite_for_text("THIRD =)", "myfont");
